 ...
 class TableHeaderChassis {
    constructor () {
        this.header = [
            ...
            ["NVMe: NVMe type 1 fronted by NVMe type 7 for RocksDB ?","use-nvme-7","checkbox"],
            ["NMVe: NVMe7 (as RocksDB for NVMe1) size in TB","size-nvme-7","input"],
            ["NMVe: #NVMe1 per NVMe type 7 for RocksDB (#NVMe covered by one NVMe7)","nvme-to-nvme7","input"],
            ["NVMe: NVMe type 1 fronted by NVMe type 8 for WAL ?","use-nvme-8","checkbox"],
            ["NMVe: NVMe8 (as WAL for NVMe1) size in TB","size-nvme-8","input"],
            ["NMVe: #NVMe1 per NVMe type 8 for WAL (#NVMe covered by one NVMe8)","nvme-to-nvme8","input"],
