...
const dcConfigDetermineNumberOfMediaRequired = function (generalValues, workloadsArrayLocal, sizingConstraints, dcConfigArrayLocal, chassisArrayLocal, actualChassisID) {
  ...
  for (let dcItem = 0; dcItem < generalValues.numberOfDCsPossible; dcItem++) {
    if(dcConfigArrayLocal[dcItem].numberOfWorkloadsInDC >0){
      ...
      for (let workloadItem = 0; workloadItem < generalValues.numberOfWorkloadsPossible; workloadItem++) {
        ...
        if (workloadsArrayLocal[workloadItem].reqCapacityNet > 0) {
          ...
          if (workloadsArrayLocal[workloadItem].selectorArrayDC[dcItem] === true && workloadsArrayLocal[workloadItem].useCase === "rgwdata" ) {
            ...
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 206, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] workload in ACTUAL DC #${dcItem} and is type ${workloadsArrayLocal[workloadItem].useCase}`,0,0,0)
            if (workloadsArrayLocal[workloadItem].sumNumberDC === 1) {
              ...
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 209, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] workload ONLY in ACTUAL DC #${dcItem} and needed capacity for object index=${localDCObjectIndexCapacity}`,0,0,0)
            }
            else {
              localDCObjectIndexCapacity = workloadsArrayLocal[workloadItem].reqCapacityNet * 1000*1000*1000*1000/(workloadsArrayLocal[workloadItem].sizeAvgObj * 1024) * sizingConstraints.expectedAverageEntrySizeInObjectIndexInBytes / 1024/1024/1024/1024 * workloadsArrayLocal[workloadItem].selectorRGWLifecycleNumVersions * workloadsArrayLocal[workloadItem].reqNumReplica / workloadsArrayLocal[workloadItem].sumNumberDC
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 213, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] workloadsArrayLocal[workloadItem].sizeAvgObj=${workloadsArrayLocal[workloadItem].sizeAvgObj}`,0,0,0)
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 214, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] workload NOT ONLY in ACTUAL DC #${dcItem} and needed capacity for object index=${localDCObjectIndexCapacity}`,0,0,0)

            }

            // Determine desired configuration for object index and add capacity to where needed.
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 219, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} selected capacity for dedicated object index=${workloadsArrayLocal[workloadItem].selectorRGWIndexDedicatedFlashPool}`,0,0,0)
            if (workloadsArrayLocal[workloadItem].selectorRGWIndexDedicatedFlashPool === true) {
              ...
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 225, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} needs capacity for dedicated object index=${localDCDedicatedObjectIndexCapacity}`,0,0,0)
            }
            else {
              ...
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 230, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} no dedicated index pool`,0,0,0)
              ...
              if (workloadsArrayLocal[workloadItem].selectorHDDDedicatedNVMe === true) {
                ...
                if (workloadsArrayLocal[workloadItem].selectorHDDDedicatedNVMeForWAL === true) {
                  ...
                  debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 237, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} needs index capacity on dedicated NVMe4 for HDD(NVMe4) + WAL on NVMe9:${localDCRequiredIndexCapacityOnNVMe4DedicatedWALonNVMe9}`,0,0,0)  
                }
                else {
                  // RocksDB is on NVMe4 - so index as well even with dedicated WAL
                  if (workloadsArrayLocal[workloadItem].selectorHDDDedicatedSSDForWAL === true) {
                    ...
                    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 243, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} needs index capacity on dedicated NVMe4 for HDD(NVMe4) + WAL on SSD9:${localDCRequiredIndexCapacityOnNVMe4DedicatedWALonSSD9}`,0,0,0)  
                  }
                  else {
                    ...
                    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 248, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} needs index capacity on dedicated NVMe4 for HDD(NVMe4):${localDCRequiredIndexCapacityOnNVMe4IncludingWAL}`,0,0,0)
                  }
                }
              }
              else {
                if (workloadsArrayLocal[workloadItem].selectorHDDDedicatedSSD === true) {
                  ...
                  if (workloadsArrayLocal[workloadItem].selectorHDDDedicatedNVMeForWAL === true) {
                    ...
                    if (workloadsArrayLocal[workloadItem].selectorHDDDedicatedSSDForWAL === true) {
                      ...
                      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 268, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} - dedicated SSD4 for RocksDB but no dedicated WAL - needs index capacity on SSD4:${localDCRequiredIndexCapacityOnSSD4IncludingWAL}`,0,0,0)
                    }
                  }
                }
                else {
                  ...
                  if (workloadsArrayLocal[workloadItem].selectorSSDDedicatedNVMeForWAL === true) {
                    ...
                    if (workloadsArrayLocal[workloadItem].selectorSSDDedicatedSSDForWAL === true) {
                      ...
                      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 285, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} - no dedicated NVMe/SSD for RocksDB nor WAL - needs index capacity on HDD1:${localDCRequiredIndexCapacityOnHDDIncludingWAL}`,0,0,0)
                    }
                  }
                }
              }
              ...
              if (workloadsArrayLocal[workloadItem].selectorNVMe === true) {
                ...
                if (workloadsArrayLocal[workloadItem].selectorNVMe1DedicatedNVMe === true) {
                  ...
                  debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 298, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} needs index capacity on dedicated NVMe for NVMe1(NVMe7):${localDCRequiredIndexCapacityOnNVMe7DedicatedWAL}`,0,0,0)  
                  }
                  else {
                    ...
                    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 302, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} needs index capacity on dedicated NVMe for NVMe(NVMe7):${localDCRequiredIndexCapacityOnNVMe7IncludingWAL}`,0,0,0)  
                  }
                }
                else {
                  // RocksDB is on NVMe1 - index is on NVMe1
                    if (workloadsArrayLocal[workloadItem].selectorNVMe1DedicatedNVMeForWAL === true) {
                      ...
                      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 309, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} - no dedicated NVMe for RocksDB but WAL - needs index capacity on NVMe1:${localDCRequiredIndexCapacityOnNVMe1DedicatedWAL}`,0,0,0)
                    }
                    else {
                      ...
                      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 313, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} - no dedicated NVMe for RocksDB nor WAL - needs index capacity on NVMe1:${localDCRequiredIndexCapacityOnNVMe1NorWAL}`,0,0,0)
                    }
                }
              }
              else {
                ...
                if (workloadsArrayLocal[workloadItem].selectorSSDDedicatedNVMe === true) {
                  ...
                  if (workloadsArrayLocal[workloadItem].selectorSSDDedicatedNVMeForWAL === true) {
                    ...
                    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 323, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} needs index capacity on dedicated NVMe for SSD1(NVMe5):${localDCRequiredIndexCapacityOnNVMe5DedicatedWAL}`,0,0,0)  
                  }
                  else {
                    // RocksDB is on NVMe5
                    ...
                    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 328, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} needs index pool on dedicated NVMe for SSD1(NVMe5):${localDCRequiredIndexCapacityOnNVMe5NorWAL}`,0,0,0)
                  }
                }
                else {
                  // RocksDB is on SSD1
                  if (workloadsArrayLocal[workloadItem].selectorSSDDedicatedNVMeForWAL === true) {
                    ...
                    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 335, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} - no dedicated NVMe for RocksDB - needs index capacity on SSD1 - w/ extra WAL:${localDCRequiredIndexCapacityOnSSD1DedicatedWAL}`,0,0,0)
                  }
                  else {
                    localDCRequiredIndexCapacityOnSSD1NorWAL += localDCObjectIndexCapacity * workloadsArrayLocal[workloadItem].reqFlashPercent / 100
                    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 339, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} - no dedicated NVMe for RocksDB nor WAL - needs index capacity on SSD1:${localDCRequiredIndexCapacityOnSSD1NorWAL}`,0,0,0)
                  }
                }
              }
            }
            ...
            if (workloadsArrayLocal[workloadItem].selectorRGWCache === true) {
              if (chassisArrayLocal[actualChassisID].useRGWCaching == 1) {
                ...
                debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 349, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] RGW cache media needed=${localDCNumberOfRGWCacheMedia}`,0,0,0)
              }
              else {
                displayMsg(document, "dcConfigDetermineNumberOfMediaRequired", 352, "error", `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] RGW cache media selected but chassis doesn't support it`,0,0,0)
              }
            ...
            if (workloadsArrayLocal[workloadItem].selectorHDDDedicatedNVMe === true) {
              ...
              if (workloadsArrayLocal[workloadItem].selectorHDDDedicatedSSD === true) {
                ...
                if (workloadsArrayLocal[workloadItem].selectorHDDDedicatedNVMeForWAL === true) {
                  ...
                  debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 365, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} - no dedicated NVMe for RocksDB - needs index capacity on SSD1 - w/ extra WAL:${localDCRequiredIndexCapacityOnSSD1DedicatedWAL}`,0,0,0)
                }
                else {
                  if (workloadsArrayLocal[workloadItem].selectorHDDDedicatedSSDForWAL === true) {
                    localDCDCCorrectionForUnalignedObjectsHDD1OnSSD4DedicatedWALonSSD9 += localWorkloadCorrectionForUnalignedObjectsHDD
                    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 390, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} - no dedicated NVMe for RocksDB - needs index capacity on SSD1 - w/ extra WAL:${localDCRequiredIndexCapacityOnSSD1DedicatedWAL}`,0,0,0)
                  }
                  else {
                    localDCDCCorrectionForUnalignedObjectsHDD1OnSSD4IncludingWAL += localWorkloadCorrectionForUnalignedObjectsHDD
                    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 394, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} - no dedicated NVMe for RocksDB nor WAL - needs index capacity on SSD1:${localDCRequiredIndexCapacityOnSSD1NorWAL}`,0,0,0)
                  }
                }
              }
              else {
                ...
                if (workloadsArrayLocal[workloadItem].selectorHDDDedicatedNVMeForWAL === true) {
                  ...
                  if (workloadsArrayLocal[workloadItem].selectorHDDDedicatedSSDForWAL === true) {
                    ...
                    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 407, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} - no dedicated NVMe for RocksDB - needs index capacity on SSD1 - w/ extra WAL:${localDCRequiredIndexCapacityOnSSD1DedicatedWAL}`,0,0,0)
                  }
                  else {  
                    localDCDCCorrectionForUnalignedObjectsHDD1WithoutDedicatedRocksDBNorWAL += localWorkloadCorrectionForUnalignedObjectsHDD
                    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 411, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] rgw workload in DC#${dcItem} - no dedicated NVMe for RocksDB nor WAL - needs index capacity on SSD1:${localDCRequiredIndexCapacityOnSSD1NorWAL}`,0,0,0)
                  }
                }
            ...
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 463, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local capacity correction unaligned RGW object parts - for HDD=${localWorkloadCorrectionForUnalignedObjectsHDD}`,0,0,0)
          ...
          if (workloadsArrayLocal[workloadItem].selectorArrayDC[dcItem] === true && workloadsArrayLocal[workloadItem].useCase === "filedata" ) { 
            ...
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 469, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] CephFS workload in DC#${dcItem} - selection: workloadsArrayLocal[workloadItem].selectorHDDDedicatedNVMeForWAL=${workloadsArrayLocal[workloadItem].selectorHDDDedicatedNVMeForWAL}`,0,0,0)
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 470, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] CephFS workload in DC#${dcItem} - selection: workloadsArrayLocal[workloadItem].selectorHDDDedicatedSSD=${workloadsArrayLocal[workloadItem].selectorHDDDedicatedSSD}`,0,0,0)
            ...
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 570, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local capacity correction unaligned file parts - for HDD=${localDCDCCorrectionForUnalignedObjectsHDD1WithoutDedicatedRocksDBDedicatedWALonNVMe9}`,0,0,0)
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 572, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local capacity correction unaligned file parts - for HDD=${localDCDCCorrectionForUnalignedObjectsHDD1WithoutDedicatedRocksDBDedicatedWALonSSD9}`,0,0,0)
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 573, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local capacity correction unaligned file parts - for HDD=${localDCDCCorrectionForUnalignedObjectsHDD1WithoutDedicatedRocksDBNorWAL}`,0,0,0)
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 574, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local capacity correction unaligned file parts - for HDD=${localDCDCCorrectionForUnalignedObjectsHDD1OnSSD4DedicatedWALonNVMe9}`,0,0,0)
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 575, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local capacity correction unaligned file parts - for HDD=${localDCDCCorrectionForUnalignedObjectsHDD1OnSSD4DedicatedWALonSSD9}`,0,0,0)
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 576, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local capacity correction unaligned file parts - for HDD=${localDCDCCorrectionForUnalignedObjectsHDD1OnSSD4IncludingWAL}`,0,0,0)
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 577, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local capacity correction unaligned file parts - for HDD=${localDCDCCorrectionForUnalignedObjectsHDD1OnNVMe4DedicatedWALonNVMe9}`,0,0,0)
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 578, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local capacity correction unaligned file parts - for HDD=${localDCDCCorrectionForUnalignedObjectsHDD1OnNVMe4DedicatedWALonSSD9}`,0,0,0)
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 579, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local capacity correction unaligned file parts - for HDD=${localDCDCCorrectionForUnalignedObjectsHDD1OnNVMe4IncludingWAL}`,0,0,0)
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 580, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local capacity correction unaligned file parts - for SSD w/ RocksDB w/ WAL =${localDCCorrectionForUnalignedObjectsSSD1WithDedicatedRocksDBDedicatedWAL}, for SSD w/ RocksDB w/o WAL =${localDCCorrectionForUnalignedObjectsSSD1WithDedicatedRocksDBIncludingWAL}`,0,0,0)
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 581, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local capacity correction unaligned file parts - for SSD w/o RocksDB w/ WAL =${localDCCorrectionForUnalignedObjectsSSD1WithoutDedicatedRocksDBDedicatedWAL}, for SSD w/o RocksDB w/o WAL =${localDCCorrectionForUnalignedObjectsSSD1WithoutDedicatedRocksDBNorWAL}`,0,0,0)
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 582, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local capacity correction unaligned file parts - for NVMe w/ RocksDB w/ WAL =${localDCCorrectionForUnalignedObjectsNVMe1WithDedicatedRocksDBDedicatedWAL}, for NVMe w/ RocksDB w/o WAL =${localDCCorrectionForUnalignedObjectsNVMe1WithDedicatedRocksDBIncludingWAL}`,0,0,0)
            debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 583, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local capacity correction unaligned file parts - for NVMe w/o RocksDB w/ WAL =${localDCCorrectionForUnalignedObjectsNVMe1WithoutDedicatedRocksDBDedicatedWAL}, for NVMe w/o RocksDB w/o WAL =${localDCCorrectionForUnalignedObjectsNVMe1WithoutDedicatedRocksDBNorWAL}`,0,0,0)
          }
          ...
          if (workloadsArrayLocal[workloadItem].selectorArrayDC[dcItem] === true) {
            ...
            if (generalValues.globalDebug == true || localDebugOn == true) {
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 728, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local DC HDD1 capacity localHDDCapacityWithDedicatedRocksDBNVMe4DedicatedWALonNVMe9=${localHDDCapacityWithDedicatedRocksDBNVMe4DedicatedWALonNVMe9}`,0,0,0)
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 729, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local DC HDD1 capacity localHDDCapacityWithDedicatedRocksDBNVMe4DedicatedWALonSSD9=${localHDDCapacityWithDedicatedRocksDBNVMe4DedicatedWALonSSD9}`,0,0,0)
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 730, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local DC HDD1 capacity localHDDCapacityWithDedicatedRocksDBNVMe4IncludingWAL=${localHDDCapacityWithDedicatedRocksDBNVMe4IncludingWAL}`,0,0,0)
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 731, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local DC HDD1 capacity localHDDCapacityWithDedicatedRocksDBSSD4DedicatedWALonNVMe9=${localHDDCapacityWithDedicatedRocksDBSSD4DedicatedWALonNVMe9}`,0,0,0)
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 732, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local DC HDD1 capacity localHDDCapacityWithDedicatedRocksDBSSD4DedicatedWALonSSD9=${localHDDCapacityWithDedicatedRocksDBSSD4DedicatedWALonSSD9}`,0,0,0)
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 733, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local DC HDD1 capacity localHDDCapacityWithDedicatedRocksDBSSD4IncludingWAL=${localHDDCapacityWithDedicatedRocksDBSSD4IncludingWAL}`,0,0,0)
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 734, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local DC HDD1 capacity localHDDCapacityWithoutDedicatedRocksDBDedicatedWALonNVMe9=${localHDDCapacityWithoutDedicatedRocksDBDedicatedWALonNVMe9}`,0,0,0)
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 735, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local DC HDD1 capacity localHDDCapacityWithoutDedicatedRocksDBDedicatedWALonSSD9=${localHDDCapacityWithoutDedicatedRocksDBDedicatedWALonSSD9}`,0,0,0)
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 736, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local DC HDD1 capacity localHDDCapacityWithoutDedicatedRocksDBNorWAL=${localHDDCapacityWithoutDedicatedRocksDBNorWAL}`,0,0,0)

              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 737, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local DC NVMe1 capacity localNVMe1CapacityWithDedicatedRocksDBDedicatedWAL=${localNVMe1CapacityWithDedicatedRocksDBDedicatedWAL}`,0,0,0)
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 738, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local DC NVMe1 capacity localNVMe1CapacityWithDedicatedRocksDBIncludingWAL=${localNVMe1CapacityWithDedicatedRocksDBIncludingWAL}`,0,0,0)
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 739, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local DC NVMe1 capacity localNVMe1CapacityWithoutDedicatedRocksDBDedicatedWAL=${localNVMe1CapacityWithoutDedicatedRocksDBDedicatedWAL}`,0,0,0)
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 740, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local DC NVMe1 capacity localNVMe1CapacityWithoutDedicatedRocksDBNorWAL=${localNVMe1CapacityWithoutDedicatedRocksDBNorWAL}`,0,0,0)
              
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 741, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local DC SSD1 capacity localSSDCapacityWithDedicatedRocksDBDedicatedWAL=${localSSDCapacityWithDedicatedRocksDBDedicatedWAL}`,0,0,0)
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 742, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local DC SSD1 capacity localSSDCapacityWithDedicatedRocksDBIncludingWAL=${localSSDCapacityWithDedicatedRocksDBIncludingWAL}`,0,0,0)
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 743, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local DC SSD1 capacity localSSDCapacityWithoutDedicatedRocksDBDedicatedWAL=${localSSDCapacityWithoutDedicatedRocksDBDedicatedWAL}`,0,0,0)
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 744, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local DC SSD1 capacity localSSDCapacityWithoutDedicatedRocksDBNorWAL=${localSSDCapacityWithoutDedicatedRocksDBNorWAL}`,0,0,0)
              
              debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 745, `[chassisID=${actualChassisID},workloadID=${workloadItem},DC=${dcItem}] local capacity corrected of RocksDB space for unaligned data parts - for SSD w/ dedicated RocksDB w/ dedicated WAL=${localDCRocksDBSizeSSDWithDedicatedNVMeDedicatedWAL}`,0,0,0)
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 753, `[chassisID=${actualChassisID},DC=${dcItem}] actualChassisID=${actualChassisID}, chassisArrayLocal[actualChassisID].chassisID=${chassisArrayLocal[actualChassisID].chassisID}, maxHDDSlots=${chassisArrayLocal[actualChassisID].maxHDDSlots}`,0,0,0)
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 755, `[chassisID=${actualChassisID},DC=${dcItem}] localDCDedicatedObjectIndexCapacity=${localDCDedicatedObjectIndexCapacity} / chassisArrayLocal[actualChassisID].sizeNVMe6 ${chassisArrayLocal[actualChassisID].sizeNVMe6}`,0,0,0)
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 756, `[chassisID=${actualChassisID},DC=${dcItem}] #NVMe6 needed=${dcConfigArrayLocal[dcItem].numberOfNVMe6Needed}`,0,0,0)
      ...
      if (generalValues.globalDebug == true || localDebugOn == true) {
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 766, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRocksDBSizeHDDWithDedicatedSSD4IncludingWAL=${localDCRocksDBSizeHDDWithDedicatedSSD4IncludingWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 767, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRocksDBSizeHDDWithDedicatedNVMe4IncludingWAL=${localDCRocksDBSizeHDDWithDedicatedNVMe4IncludingWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 768, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRequiredIndexCapacityOnHDDIncludingWAL=${localDCRequiredIndexCapacityOnHDDIncludingWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 769, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRequiredIndexCapacityOnHDDDedicatedWALonSSD9=${localDCRequiredIndexCapacityOnHDDDedicatedWALonSSD9}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 770, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRequiredIndexCapacityOnHDDDedicatedWALonNVMe9=${localDCRequiredIndexCapacityOnHDDDedicatedWALonNVMe9}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 771, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRequiredIndexCapacityOnNVMe4DedicatedWALonNVMe9=${localDCRequiredIndexCapacityOnNVMe4DedicatedWALonNVMe9}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 772, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRequiredIndexCapacityOnNVMe4DedicatedWALonSSD9=${localDCRequiredIndexCapacityOnNVMe4DedicatedWALonSSD9}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 773, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRequiredIndexCapacityOnNVMe4IncludingWAL=${localDCRequiredIndexCapacityOnNVMe4IncludingWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 774, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRequiredIndexCapacityOnSSD4IncludingWAL=${localDCRequiredIndexCapacityOnSSD4IncludingWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 775, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRocksDBSizeHDDWithDedicatedNVMe4DedicatedWALonNVMe9=${localDCRocksDBSizeHDDWithDedicatedNVMe4DedicatedWALonNVMe9}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 776, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRocksDBSizeHDDWithDedicatedSSD4DedicatedWALonNVMe9=${localDCRocksDBSizeHDDWithDedicatedSSD4DedicatedWALonNVMe9}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 777, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRocksDBSizeHDDWithDedicatedNVMe4DedicatedWALonSSD9=${localDCRocksDBSizeHDDWithDedicatedNVMe4DedicatedWALonSSD9}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 778, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRocksDBSizeHDDWithDedicatedSSD4DedicatedWALonSSD9=${localDCRocksDBSizeHDDWithDedicatedSSD4DedicatedWALonSSD9}`,0,0,0)
      }
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 792, `[chassisID=${actualChassisID},DC=${dcItem}] dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithoutDedicatedRocksDBDedicatedWALonNVMe9=${dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithoutDedicatedRocksDBDedicatedWALonNVMe9}`,0,0,0)
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 793, `[chassisID=${actualChassisID},DC=${dcItem}] dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithoutDedicatedRocksDBDedicatedWALonSSD9=${dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithoutDedicatedRocksDBDedicatedWALonSSD9}`,0,0,0)
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 794, `[chassisID=${actualChassisID},DC=${dcItem}] dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedNVMe4DedicatedWALonNVMe9=${dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedNVMe4DedicatedWALonNVMe9}`,0,0,0)
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 795, `[chassisID=${actualChassisID},DC=${dcItem}] dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedNVMe4DedicatedWALonSSD9=${dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedNVMe4DedicatedWALonSSD9}`,0,0,0)
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 796, `[chassisID=${actualChassisID},DC=${dcItem}] dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedSSD4DedicatedWALonNVMe9=${dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedSSD4DedicatedWALonNVMe9}`,0,0,0)
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 797, `[chassisID=${actualChassisID},DC=${dcItem}] dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedSSD4DedicatedWALonSSD9=${dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedSSD4DedicatedWALonSSD9}`,0,0,0)
      ...
      if (chassisArrayLocal[actualChassisID].sizeSSD9 == 0){
        ...
        if (chassisArrayLocal[actualChassisID].useSSD9 == true){
          ...
          debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 832, `[chassisID=${actualChassisID},DC=${dcItem}] #SSD9 needed=${dcConfigArrayLocal[dcItem].numberOfSSD9Needed}`,0,0,0)
        }
        else {
          if ((dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithoutDedicatedRocksDBDedicatedWALonSSD9 + dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedNVMe4DedicatedWALonSSD9 + dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedSSD4DedicatedWALonSSD9) > 0) {
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 835, `[chassisID=${actualChassisID},DC=${dcItem}] dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBDedicatedWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBDedicatedWAL}`,0,0,0)
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 836, `[chassisID=${actualChassisID},DC=${dcItem}] dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBDedicatedWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBDedicatedWAL}`,0,0,0)
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 839, `[chassisID=${actualChassisID},DC=${dcItem}] #NVMe3 needed=${dcConfigArrayLocal[dcItem].numberOfNVMe3Needed}`,0,0,0)
      ...
      if (dcConfigArrayLocal[dcItem].numberOfNVMe3Needed < (Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBDedicatedWAL / chassisArrayLocal[actualChassisID].nvmeToNVMe3) + Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBDedicatedWAL / chassisArrayLocal[actualChassisID].nvmeToNVMe3) )){
        ...
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 843, `[chassisID=${actualChassisID},DC=${dcItem}] #NVMe3 needed=${dcConfigArrayLocal[dcItem].numberOfNVMe3Needed} < Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBDedicatedWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBDedicatedWAL} / chassisArrayLocal[actualChassisID].nvmeToNVMe3=${chassisArrayLocal[actualChassisID].nvmeToNVMe3}) + Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBDedicatedWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBDedicatedWAL} / chassisArrayLocal[actualChassisID].nvmeToNVMe3=${chassisArrayLocal[actualChassisID].nvmeToNVMe3})`,0,0,0)
        dcConfigArrayLocal[dcItem].numberOfNVMe3Needed = Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBDedicatedWAL / chassisArrayLocal[actualChassisID].nvmeToNVMe3) + Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBDedicatedWAL / chassisArrayLocal[actualChassisID].nvmeToNVMe3)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 845, `[chassisID=${actualChassisID},DC=${dcItem}] #NVMe3 needed=${dcConfigArrayLocal[dcItem].numberOfNVMe3Needed}`,0,0,0)
      }
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 847, `[chassisID=${actualChassisID},DC=${dcItem}] #NVMe3 needed=${dcConfigArrayLocal[dcItem].numberOfNVMe3Needed}`,0,0,0)

      // NVMe1:
      if (generalValues.globalDebug == true || localDebugOn == true) {
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 851, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRocksDBSizeNVMe1WithDedicatedNVMeIncludingWAL=${localDCRocksDBSizeNVMe1WithDedicatedNVMeIncludingWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 852, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRequiredIndexCapacityOnNVMe1NorWAL=${localDCRequiredIndexCapacityOnNVMe1NorWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 853, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRequiredIndexCapacityOnNVMe1DedicatedWAL=${localDCRequiredIndexCapacityOnNVMe1DedicatedWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 854, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRequiredIndexCapacityOnNVMe7DedicatedWAL=${localDCRequiredIndexCapacityOnNVMe7DedicatedWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 855, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRequiredIndexCapacityOnNVMe7IncludingWAL=${localDCRequiredIndexCapacityOnNVMe7IncludingWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 856, `[chassisID=${actualChassisID},DC=${dcItem}] localDCRocksDBSizeNVMe1WithDedicatedNVMeDedicatedWAL=${localDCRocksDBSizeNVMe1WithDedicatedNVMeDedicatedWAL}`,0,0,0)
      }
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 863, `[chassisID=${actualChassisID},DC=${dcItem}] dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithoutDedicatedRocksDBDedicatedWAL=${dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithoutDedicatedRocksDBDedicatedWAL}`,0,0,0)
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 864, `[chassisID=${actualChassisID},DC=${dcItem}] dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithDedicatedRocksDBDedicatedWAL=${dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithDedicatedRocksDBDedicatedWAL}`,0,0,0)
      // NVMe8 for NVMe1
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 867, `[chassisID=${actualChassisID},DC=${dcItem}] #NVMe8 needed=${dcConfigArrayLocal[dcItem].numberOfNVMe8Needed}`,0,0,0)
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 878, `[chassisID=${actualChassisID},DC=${dcItem}] #NVMe2 needed=${dcConfigArrayLocal[dcItem].numberOfNVMe2Needed}`,0,0,0)
      ...
      // HDD:
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 893, `[chassisID=${actualChassisID},DC=${dcItem}] #HDD needed=${dcConfigArrayLocal[dcItem].numberOfHDDNeeded}`,0,0,0)
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 901, `[chassisID=${actualChassisID},DC=${dcItem}]#HDD(sum) needed=${dcConfigArrayLocal[dcItem].numberOfHDDNeeded}`,0,0,0)
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 908, `[chassisID=${actualChassisID},DC=${dcItem}]#HDD(sum) needed=${dcConfigArrayLocal[dcItem].numberOfHDDNeeded}`,0,0,0)
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 915, `[chassisID=${actualChassisID},DC=${dcItem}]#HDD(sum) needed=${dcConfigArrayLocal[dcItem].numberOfHDDNeeded}`,0,0,0)
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 920, `[chassisID=${actualChassisID},DC=${dcItem}]#HDD(sum) needed=${dcConfigArrayLocal[dcItem].numberOfHDDNeeded}`,0,0,0)
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 924, `[chassisID=${actualChassisID},DC=${dcItem}]#HDD(sum) needed=${dcConfigArrayLocal[dcItem].numberOfHDDNeeded}`,0,0,0)

      if (generalValues.globalDebug == true || localDebugOn == true) {
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 927, `[chassisID=${actualChassisID},DC=${dcItem}] #HDD w/o NVMe nor dedicated WAL needed=${dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithoutDedicatedRocksDBNorWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 928, `[chassisID=${actualChassisID},DC=${dcItem}] #HDD w/o NVMe w/ dedicated WAL NVMe9 needed=${dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithoutDedicatedRocksDBDedicatedWALonNVMe9}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 929, `[chassisID=${actualChassisID},DC=${dcItem}] #HDD w/o NVMe w/ dedicated WAL SSD9 needed=${dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithoutDedicatedRocksDBDedicatedWALonSSD9}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 930, `[chassisID=${actualChassisID},DC=${dcItem}] #HDD w/ NVMe dedicated w/o separate WAL needed=${dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedNVMe4IncludingWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 931, `[chassisID=${actualChassisID},DC=${dcItem}] #HDD w/ SSD dedicated w/o separate WAL needed=${dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedSSD4IncludingWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 932, `[chassisID=${actualChassisID},DC=${dcItem}] #HDD w/ NVMe dedicated w/ separate WAL SSD9 needed=${dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedNVMe44DedicatedWALonSSD9}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 933, `[chassisID=${actualChassisID},DC=${dcItem}] #HDD w/ SSD dedicated w/ separate WAL SSD9 needed=${dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedSSD4DedicatedWALonSSD9}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 934, `[chassisID=${actualChassisID},DC=${dcItem}] #HDD w/ NVMe dedicated w/ separate WAL NVMe9 needed=${dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedNVMe44DedicatedWALonNVMe9}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 935, `[chassisID=${actualChassisID},DC=${dcItem}] #HDD w/ SSD dedicated w/ separate WAL NVMe9 needed=${dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedSSD4DedicatedWALonNVMe9}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 936, `[chassisID=${actualChassisID},DC=${dcItem}] #HDD(sum)) needed=${dcConfigArrayLocal[dcItem].numberOfHDDNeeded}`,0,0,0)
      }
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 952, `[chassisID=${actualChassisID},DC=${dcItem}]#SSD(sum) needed=${dcConfigArrayLocal[dcItem].numberOfSSDNeeded}`,0,0,0)
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 956, `[chassisID=${actualChassisID},DC=${dcItem}]#SSD(sum) needed=${dcConfigArrayLocal[dcItem].numberOfSSDNeeded}`,0,0,0)

      if (generalValues.globalDebug == true || localDebugOn == true) {
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 959, `[chassisID=${actualChassisID},DC=${dcItem}] #SSD w/o NVMe nor dedicated WAL needed=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 960, `[chassisID=${actualChassisID},DC=${dcItem}] #SSD w/o NVMe w/ dedicated WAL needed=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBDedicatedWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 961, `[chassisID=${actualChassisID},DC=${dcItem}] #SSD w/ NVMe dedicated w/o separate WAL needed=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 962, `[chassisID=${actualChassisID},DC=${dcItem}] #SSD w/ NVMe dedicated w/ separate WAL needed=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBDedicatedWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 963, `[chassisID=${actualChassisID},DC=${dcItem}] #SSD(sum)) needed=${dcConfigArrayLocal[dcItem].numberOfSSDNeeded}`,0,0,0)
      }
      ...
      if (generalValues.globalDebug == true || localDebugOn == true) {
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 982, `[chassisID=${actualChassisID},DC=${dcItem}] #NVMe1 w/o NVMe nor dedicated WAL needed=${dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithoutDedicatedRocksDBNorWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 983, `[chassisID=${actualChassisID},DC=${dcItem}] #NVMe1 w/o NVMe w/ dedicated WAL needed=${dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithoutDedicatedRocksDBDedicatedWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 984, `[chassisID=${actualChassisID},DC=${dcItem}] #NVMe1 w/ NVMe dedicated w/o separate WAL needed=${dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithDedicatedRocksDBIncludingWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 985, `[chassisID=${actualChassisID},DC=${dcItem}] #NVMe1 w/ NVMe dedicated w/ separate WAL needed=${dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithDedicatedRocksDBDedicatedWAL}`,0,0,0)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 986, `[chassisID=${actualChassisID},DC=${dcItem}] #NVMe1(sum)) needed=${dcConfigArrayLocal[dcItem].numberOfNVMe1Needed}`,0,0,0)
      }
      ...
      if (dcConfigArrayLocal[dcItem].numberOfNVMe4Needed < (Math.ceil(dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedNVMe4DedicatedWALonNVMe9 / chassisArrayLocal[actualChassisID].ssdToNVMe4) + Math.ceil(dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedNVMe4DedicatedWALonSSD9 / chassisArrayLocal[actualChassisID].ssdToNVMe4) + Math.ceil(dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedNVMe4IncludingWAL / chassisArrayLocal[actualChassisID].ssdToNVMe4)) ){
        ...
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 1002, `[chassisID=${actualChassisID},DC=${dcItem}] #NVMe4 needed=${dcConfigArrayLocal[dcItem].numberOfNVMe4Needed}`,0,0,0)
      }
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 1004, `[chassisID=${actualChassisID},DC=${dcItem}] #NVMe4 needed=${dcConfigArrayLocal[dcItem].numberOfNVMe4Needed}`,0,0,0)
      ...
      if (dcConfigArrayLocal[dcItem].numberOfSSD4Needed < (Math.ceil(dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedSSD4DedicatedWALonNVMe9 / chassisArrayLocal[actualChassisID].ssdToSSD4) + Math.ceil(dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedSSD4DedicatedWALonSSD9 / chassisArrayLocal[actualChassisID].ssdToSSD4) + Math.ceil(dcConfigArrayLocal[dcItem].numberOfHDD1NeededWithDedicatedSSD4IncludingWAL / chassisArrayLocal[actualChassisID].ssdToSSD4)) ){
        ...
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 1015, `[chassisID=${actualChassisID},DC=${dcItem}] #SSD4 needed=${dcConfigArrayLocal[dcItem].numberOfSSD4Needed}`,0,0,0)
      }
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 1017, `[chassisID=${actualChassisID},DC=${dcItem}] #SSD4 needed=${dcConfigArrayLocal[dcItem].numberOfSSD4Needed}`,0,0,0)
      ...
      if (dcConfigArrayLocal[dcItem].numberOfNVMe5Needed < (Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBDedicatedWAL / chassisArrayLocal[actualChassisID].ssdToNVMe5) + Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL / chassisArrayLocal[actualChassisID].ssdToNVMe5)) ){
        ...
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 1025, `[chassisID=${actualChassisID},DC=${dcItem}] #NVMe5 needed=${dcConfigArrayLocal[dcItem].numberOfNVMe5Needed}`,0,0,0)
      }
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 1027, `[chassisID=${actualChassisID},DC=${dcItem}] #NVMe5 needed=${dcConfigArrayLocal[dcItem].numberOfNVMe5Needed}`,0,0,0)
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfMediaRequired", 1031, `[chassisID=${actualChassisID},DC=${dcItem}] #NVMe7 needed=${dcConfigArrayLocal[dcItem].numberOfNVMe7Needed}`,0,0,0)
