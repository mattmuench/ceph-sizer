...
const dcConfigDetermineNumberOfServersInitially = function (generalValues, dcConfigArrayLocal, chassisArrayLocal, actualChassisID, dcItem) {
  ...
  if (generalValues.globalDebug == true || localDebugOn == true) {
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 21, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllSSD=${localNumberOfAllSSD}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 22, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllSSD=${dcConfigArrayLocal[dcItem].numberOfSSD4Needed}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 23, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllSSD=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 24, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllSSD=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBDedicatedWAL}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 25, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllSSD=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBDedicatedWAL}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 26, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllSSD=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL}`,0,0,0)
  }
  // CALC: NAll
  ...
  if (generalValues.globalDebug == true || localDebugOn == true) {
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 41, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe=${localNumberOfAllNVMe}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 42, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe1RW=${dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithoutDedicatedRocksDBNorWAL}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 43, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe1R+W=${dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithoutDedicatedRocksDBDedicatedWAL}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 44, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe1+R+W=${dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithDedicatedRocksDBDedicatedWAL}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 45, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe1+RW=${dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithDedicatedRocksDBIncludingWAL}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 46, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe2=${dcConfigArrayLocal[dcItem].numberOfNVMe2Needed}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 47, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe3=${dcConfigArrayLocal[dcItem].numberOfNVMe3Needed}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 48, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe4=${dcConfigArrayLocal[dcItem].numberOfNVMe4Needed}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 49, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe5=${dcConfigArrayLocal[dcItem].numberOfNVMe5Needed}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 50, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe6=${dcConfigArrayLocal[dcItem].numberOfNVMe6Needed}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 51, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe7=${dcConfigArrayLocal[dcItem].numberOfNVMe7Needed}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 52, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe8=${dcConfigArrayLocal[dcItem].numberOfNVMe8Needed}`,0,0,0)
  }
  ...
  if ( localNumberOfAllSSD > 0) {
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 84, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllSSD=${localNumberOfAllSSD} is > 0`,0,0,0)
    ...
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 92, `[chassisID=${actualChassisID},dcItem=${dcItem}] ratioHDDvsSSD=${ratioHDDvsSSD}`,0,0,0)
  }
  if ( dcConfigArrayLocal[actualChassisID].numberOfHDDNeeded > 0) {
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 95, `[chassisID=${actualChassisID},dcItem=${dcItem}] dcConfigArrayLocal[actualChassisID].numberOfHDDNeeded=${dcConfigArrayLocal[actualChassisID].numberOfHDDNeeded} is > 0`,0,0,0)
    ...
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 103, `[chassisID=${actualChassisID},dcItem=${dcItem}] ratioHDDvsSSD=${ratioHDDvsSSD}`,0,0,0)
  }
  ...
  debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 109, `[chassisID=${actualChassisID},dcItem=${dcItem}] requiredSumOfSSDandHDD=${requiredSumOfSSDandHDD} = dcConfigArrayLocal[dcItem].numberOfHDDNeeded=${dcConfigArrayLocal[dcItem].numberOfHDDNeeded} + localNumberOfAllSSD=${localNumberOfAllSSD}`,0,0,0)
  let ratioAllActualNVMeVsAllDrives = localNumberOfAllNVMe / requiredSumOfSSDandHDD
  debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 111, `[chassisID=${actualChassisID},dcItem=${dcItem}] ratioAllActualNVMeVsAllDrives=${ratioAllActualNVMeVsAllDrives} = localNumberOfAllNVMe=${localNumberOfAllNVMe} / requiredSumOfSSDandHDD=${requiredSumOfSSDandHDD}`,0,0,0)
  let initServ = 0
  if (localNumberOfAllNVMe > 0) {
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 114, `IS: [chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe=${localNumberOfAllNVMe} > 0`,0,0,0)
    ...
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 135, `[chassisID=${actualChassisID},dcItem=${dcItem}] initServ=${initServ} = Math.ceil((requiredSumOfSSDandHDD=${requiredSumOfSSDandHDD})/chassisArrayLocal[actualChassisID].maxAllSlots=${chassisArrayLocal[actualChassisID].maxAllSlots})`,0,0,0)
  }
  let NdS = chassisArrayLocal[actualChassisID].maxDedicatedNVMeSlots
  debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 138, `[chassisID=${actualChassisID},dcItem=${dcItem}]  NdS=${NdS} = chassisArrayLocal[actualChassisID].maxDedicatedNVMeSlots=${chassisArrayLocal[actualChassisID].maxDedicatedNVMeSlots}`,0,0,0)
  ...
  debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 148, `[chassisID=${actualChassisID},dcItem=${dcItem}] generalValues.desiredSimilarMediaConfig=${generalValues.desiredSimilarMediaConfig}`,0,0,0)
  if (generalValues.desiredSimilarMediaConfig == 1) {
    ...
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 165, `[chassisID=${actualChassisID},dcItem=${dcItem}] ratNvA=${ratNvA}`,0,0,0)
    ...
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 185, `[chassisID=${actualChassisID},dcItem=${dcItem}]  NmedS=${NmedS}`,0,0,0)
    ...
    if ( SSDAll > 0) {
      ...
      if (ratHvS > 0) {
        ...
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 195, `[chassisID=${actualChassisID},dcItem=${dcItem}] HDDmedS=${HDDmedS} = RemS=${RemS} - Math.ceil(HDDAll=${HDDAll} / (ratHvS=${ratHvS} * initServ=${initServ}))`,0,0,0)
      }
      else {
        HDDmedS = 0
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 199, `[chassisID=${actualChassisID},dcItem=${dcItem}] HDDmedS=${HDDmedS}`,0,0,0)
      }  
    }
    else {
      // (24)
      HDDmedS = RemS 
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 205, `[chassisID=${actualChassisID},dcItem=${dcItem}] HDDmedS=${HDDmedS} = RemS=${RemS}`,0,0,0)
    }
    // CALC (22) or (23):
    let SSDmedS = 0
    if ( HDDAll > 0) {
    ...
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 217, `[chassisID=${actualChassisID},dcItem=${dcItem}] HDDmedS=${HDDmedS}, SSDmedS=${SSDmedS}, NmedS=${NmedS}, NdS=${NdS}`,0,0,0)
    ...
    if ( chassisArrayLocal[actualChassisID].maxAllMediaSum < (Math.max(HDDmedS,SSDmedS) + NmedS + NdS)) {
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 221, `  [chassisID=${actualChassisID},dcItem=${dcItem}] Error - more slots assigned to media than available in chassis - DC# ${dcItem} for chassisConfig ${actualChassisID} `,0,0,0)
    }
    if ( chassisArrayLocal[actualChassisID].maxAllSlots < (Math.max(HDDmedS,SSDmedS) + NmedS)) {
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 224, `[chassisID=${actualChassisID},dcItem=${dcItem}] Error - more slots in drive slots assigned to media than available in chassis - DC# ${dcItem} for chassisConfig ${actualChassisID} `,0,0,0)
    }
    ...
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 229, `[chassisID=${actualChassisID},dcItem=${dcItem}], localNumberOfAllNVMe=${localNumberOfAllNVMe}`,0,0,0)
    ...
    if ((NmedS + NdS)> 0) {
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 237, `[chassisID=${actualChassisID},dcItem=${dcItem}] actualNumberOfServersForNVMe=${actualNumberOfServersForNVMe}, tempactualNumberOfServersForNVMe=${tempactualNumberOfServersForNVMe}, tempNmedSplusNdS=${tempNmedSplusNdS}`,0,0,0)
    }
    ...
    if (HDDmedS > 0) {
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 242, `[chassisID=${actualChassisID},dcItem=${dcItem}] actualNumberOfServersForHDD=${actualNumberOfServersForHDD}`,0,0,0)
    }
    let actualNumberOfServersForSSD = 0
    if (SSDmedS > 0) {
      actualNumberOfServersForSSD = Math.ceil(localNumberOfAllSSD / SSDmedS)
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 247, `[chassisID=${actualChassisID},dcItem=${dcItem}] actualNumberOfServersForSSD=${actualNumberOfServersForSSD}`,0,0,0)
    }
    ...
    if (chassisArrayLocal[actualChassisID].useSSD4overNVMe4 > 0){
      if ( (HDDmedS/chassisArrayLocal[actualChassisID].hddToSSD4) < (dcConfigArrayLocal[dcItem].numberOfSSD4Needed/actualNumberOfServersForHDD) ){
        ...
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 275, `[chassisID=${actualChassisID},dcItem=${dcItem}] numberOfSSDPerServer=${numberOfSSDPerServer} = Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL} + dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL})/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig})`,0,0,0)  
    }
    ...
    if (chassisArrayLocal[actualChassisID].useSSD4overNVMe4 < 1){
      if ( (HDDmedS/chassisArrayLocal[actualChassisID].hddToNVMe4) < (dcConfigArrayLocal[dcItem].numberOfNVMe4Needed/actualNumberOfServersForHDD) ){
        ...
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 297, `[chassisID=${actualChassisID},dcItem=${dcItem}] numberOfNMVePerServer=${numberOfNMVePerServer} = 
        ...
        `,0,0,0)
        /**
        if (chassisArrayLocal[actualChassisID].useNVMe3) {
          numberOfNMVePerServer += Math.ceil(Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)/chassisArrayLocal[actualChassisID].ssdToNVMe3)
          debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 312, `[chassisID=${actualChassisID},dcItem=${dcItem}] adding NVMe3s: numberOfNMVePerServer=${numberOfNMVePerServer}`,0,0,0)
        }
        ...
        + Math.ceil(dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithDedicatedRocksDBDedicatedWAL / dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)
        + Math.ceil(dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithDedicatedRocksDBIncludingWAL / dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 334, `[chassisID=${actualChassisID},dcItem=${dcItem}] numberOfNMVePerServer=${numberOfNMVePerServer} = 
        ...
        /**
        if (chassisArrayLocal[actualChassisID].useNVMe3) {
          numberOfNMVePerServer += Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL/chassisArrayLocal[actualChassisID].ssdToNVMe3) 
          debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 348, `[chassisID=${actualChassisID},dcItem=${dcItem}] adding NVMe3s: numberOfNMVePerServer=${numberOfNMVePerServer}`,0,0,0)
        }
      ...
      numberOfNMVePerServer = Math.ceil(Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)/chassisArrayLocal[actualChassisID].ssdToNVMe5) 
                            ...
                            + Math.ceil(dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithDedicatedRocksDBDedicatedWAL / dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)
                            + Math.ceil(dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithDedicatedRocksDBIncludingWAL / dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 371, `[chassisID=${actualChassisID},dcItem=${dcItem}] numberOfNMVePerServer=${numberOfNMVePerServer} = 
                            Math.ceil(Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL}/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig})/chassisArrayLocal[actualChassisID].ssdToNVMe5=${chassisArrayLocal[actualChassisID].ssdToNVMe5}) 
                            + Math.ceil(Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBDedicatedWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBDedicatedWAL}/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig})/chassisArrayLocal[actualChassisID].ssdToNVMe5=${chassisArrayLocal[actualChassisID].ssdToNVMe5}) 
                            + Math.ceil(Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBDedicatedWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBDedicatedWAL}/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig})/chassisArrayLocal[actualChassisID].ssdToNVMe3=${chassisArrayLocal[actualChassisID].ssdToNVMe3}) 
                            + Math.ceil(Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBDedicatedWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBDedicatedWAL}/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig})/chassisArrayLocal[actualChassisID].ssdToNVMe3=${chassisArrayLocal[actualChassisID].ssdToNVMe3}) 
      ...
      if (chassisArrayLocal[actualChassisID].useNVMe3) {
        numberOfNMVePerServer += Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL/chassisArrayLocal[actualChassisID].ssdToNVMe3) 
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 387, `[chassisID=${actualChassisID},dcItem=${dcItem}] adding NVMe3s: numberOfNMVePerServer=${numberOfNMVePerServer}`,0,0,0)
      }
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 389, `[chassisID=${actualChassisID},dcItem=${dcItem}] numberOfNMVePerServer=${numberOfNMVePerServer}`,0,0,0)
    ...
    if (generalValues.desiredSameMediaConfig === true ) {
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 407, `[chassisID=${actualChassisID},dcItem=${dcItem}] INFO - same media config is currently not supported`,0,0,0)
    }
  } 
}
