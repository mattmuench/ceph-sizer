...
const dcConfigDetermineNumberOfServersInitially = function (generalValues, dcConfigArrayLocal, chassisArrayLocal, actualChassisID, dcItem) {
  ...
  let localNumberOfAllSSD = dcConfigArrayLocal[dcItem].numberOfSSD4Needed 
                            + dcConfigArrayLocal[dcItem].numberOfSSD9Needed 
  ...
  if (generalValues.globalDebug == true || localDebugOn == true) {
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 22, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllSSD=${localNumberOfAllSSD}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 23, `[chassisID=${actualChassisID},dcItem=${dcItem}] dcConfigArrayLocal[dcItem].numberOfSSD4Needed=${dcConfigArrayLocal[dcItem].numberOfSSD4Needed}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 24, `[chassisID=${actualChassisID},dcItem=${dcItem}] dcConfigArrayLocal[dcItem].numberOfSSD9Needed=${dcConfigArrayLocal[dcItem].numberOfSSD9Needed}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 25, `[chassisID=${actualChassisID},dcItem=${dcItem}] dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 26, `[chassisID=${actualChassisID},dcItem=${dcItem}] dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBDedicatedWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBDedicatedWAL}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 27, `[chassisID=${actualChassisID},dcItem=${dcItem}] dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBDedicatedWAL}=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBDedicatedWAL}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 28, `[chassisID=${actualChassisID},dcItem=${dcItem}] dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL}`,0,0,0)
  }
  // CALC: NAll
  let localNumberOfAllNVMe =  dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithoutDedicatedRocksDBNorWAL
                            ...
                            + dcConfigArrayLocal[dcItem].numberOfNVMe9Needed
  if (generalValues.globalDebug == true || localDebugOn == true) {
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 44, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe=${localNumberOfAllNVMe}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 45, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe1RW=${dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithoutDedicatedRocksDBNorWAL}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 46, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe1R+W=${dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithoutDedicatedRocksDBDedicatedWAL}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 47, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe1+R+W=${dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithDedicatedRocksDBDedicatedWAL}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 48, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe1+RW=${dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithDedicatedRocksDBIncludingWAL}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 49, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe2=${dcConfigArrayLocal[dcItem].numberOfNVMe2Needed}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 50, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe3=${dcConfigArrayLocal[dcItem].numberOfNVMe3Needed}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 51, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe4=${dcConfigArrayLocal[dcItem].numberOfNVMe4Needed}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 52, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe5=${dcConfigArrayLocal[dcItem].numberOfNVMe5Needed}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 53, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe6=${dcConfigArrayLocal[dcItem].numberOfNVMe6Needed}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 54, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe7=${dcConfigArrayLocal[dcItem].numberOfNVMe7Needed}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 55, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe8=${dcConfigArrayLocal[dcItem].numberOfNVMe8Needed}`,0,0,0)
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 56, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe9=${dcConfigArrayLocal[dcItem].numberOfNVMe9Needed}`,0,0,0)
  }
  ...
  if ( localNumberOfAllSSD > 0) {
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 88, `[chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllSSD=${localNumberOfAllSSD} is > 0`,0,0,0)
    ...
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 96, `[chassisID=${actualChassisID},dcItem=${dcItem}] ratioHDDvsSSD=${ratioHDDvsSSD}`,0,0,0)
  }
  if ( dcConfigArrayLocal[actualChassisID].numberOfHDDNeeded > 0) {
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 99, `[chassisID=${actualChassisID},dcItem=${dcItem}] dcConfigArrayLocal[actualChassisID].numberOfHDDNeeded=${dcConfigArrayLocal[actualChassisID].numberOfHDDNeeded} is > 0`,0,0,0)
    ...
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 107, `[chassisID=${actualChassisID},dcItem=${dcItem}] ratioHDDvsSSD=${ratioHDDvsSSD}`,0,0,0)
  }
  ...
  debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 113, `[chassisID=${actualChassisID},dcItem=${dcItem}] requiredSumOfSSDandHDD=${requiredSumOfSSDandHDD} = dcConfigArrayLocal[dcItem].numberOfHDDNeeded=${dcConfigArrayLocal[dcItem].numberOfHDDNeeded} + localNumberOfAllSSD=${localNumberOfAllSSD}`,0,0,0)
  let ratioAllActualNVMeVsAllDrives = localNumberOfAllNVMe / requiredSumOfSSDandHDD
  debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 115, `[chassisID=${actualChassisID},dcItem=${dcItem}] ratioAllActualNVMeVsAllDrives=${ratioAllActualNVMeVsAllDrives} = localNumberOfAllNVMe=${localNumberOfAllNVMe} / requiredSumOfSSDandHDD=${requiredSumOfSSDandHDD}`,0,0,0)
  let initServ = 0
  if (localNumberOfAllNVMe > 0) {
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 118, `IS: [chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe=${localNumberOfAllNVMe} > 0`,0,0,0)
    ...
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 139, `[chassisID=${actualChassisID},dcItem=${dcItem}] initServ=${initServ} = Math.ceil((requiredSumOfSSDandHDD=${requiredSumOfSSDandHDD})/chassisArrayLocal[actualChassisID].maxAllSlots=${chassisArrayLocal[actualChassisID].maxAllSlots})`,0,0,0)
  }
  let NdS = chassisArrayLocal[actualChassisID].maxDedicatedNVMeSlots
  debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 142, `[chassisID=${actualChassisID},dcItem=${dcItem}]  NdS=${NdS} = chassisArrayLocal[actualChassisID].maxDedicatedNVMeSlots=${chassisArrayLocal[actualChassisID].maxDedicatedNVMeSlots}`,0,0,0)
  ...
  debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 152, `[chassisID=${actualChassisID},dcItem=${dcItem}] generalValues.desiredSimilarMediaConfig=${generalValues.desiredSimilarMediaConfig}`,0,0,0)
  if (generalValues.desiredSimilarMediaConfig == 1) {
    ...
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 169, `[chassisID=${actualChassisID},dcItem=${dcItem}] ratNvA=${ratNvA}`,0,0,0)
    ...
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 189, `[chassisID=${actualChassisID},dcItem=${dcItem}]  NmedS=${NmedS}`,0,0,0)
    ...
    if ( SSDAll > 0) {
      ...
      if (ratHvS > 0) {
        ...
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 199, `[chassisID=${actualChassisID},dcItem=${dcItem}] HDDmedS=${HDDmedS} = RemS=${RemS} - Math.ceil(HDDAll=${HDDAll} / (ratHvS=${ratHvS} * initServ=${initServ}))`,0,0,0)
      }
      else {
        HDDmedS = 0
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 203, `[chassisID=${actualChassisID},dcItem=${dcItem}] HDDmedS=${HDDmedS}`,0,0,0)
      }  
    }
    else {
      // (24)
      HDDmedS = RemS 
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 209, `[chassisID=${actualChassisID},dcItem=${dcItem}] HDDmedS=${HDDmedS} = RemS=${RemS}`,0,0,0)
    }
    // CALC (22) or (23):
    let SSDmedS = 0
    if ( HDDAll > 0) {
    ...
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 221, `[chassisID=${actualChassisID},dcItem=${dcItem}] HDDmedS=${HDDmedS}, SSDmedS=${SSDmedS}, NmedS=${NmedS}, NdS=${NdS}`,0,0,0)
    ...
    if ( chassisArrayLocal[actualChassisID].maxAllMediaSum < (Math.max(HDDmedS,SSDmedS) + NmedS + NdS)) {
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 225, `  [chassisID=${actualChassisID},dcItem=${dcItem}] Error - more slots assigned to media than available in chassis - DC# ${dcItem} for chassisConfig ${actualChassisID} `,0,0,0)
    }
    if ( chassisArrayLocal[actualChassisID].maxAllSlots < (Math.max(HDDmedS,SSDmedS) + NmedS)) {
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 228, `[chassisID=${actualChassisID},dcItem=${dcItem}] Error - more slots in drive slots assigned to media than available in chassis - DC# ${dcItem} for chassisConfig ${actualChassisID} `,0,0,0)
    }
    ...
    debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 233, `[chassisID=${actualChassisID},dcItem=${dcItem}], localNumberOfAllNVMe=${localNumberOfAllNVMe}`,0,0,0)
    ...
    if ((NmedS + NdS)> 0) {
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 241, `[chassisID=${actualChassisID},dcItem=${dcItem}] actualNumberOfServersForNVMe=${actualNumberOfServersForNVMe}, tempactualNumberOfServersForNVMe=${tempactualNumberOfServersForNVMe}, tempNmedSplusNdS=${tempNmedSplusNdS}`,0,0,0)
    }
    ...
    if (HDDmedS > 0) {
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 262, `[chassisID=${actualChassisID},dcItem=${dcItem}] actualNumberOfServersForHDD=${actualNumberOfServersForHDD}`,0,0,0)
    }
    let actualNumberOfServersForSSD = 0
    if (SSDmedS > 0) {
      actualNumberOfServersForSSD = Math.ceil(localNumberOfAllSSD / SSDmedS)
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 251, `[chassisID=${actualChassisID},dcItem=${dcItem}] actualNumberOfServersForSSD=${actualNumberOfServersForSSD}`,0,0,0)
    }
    ...
    // CHECK: the number of SSD must now match the number of SSD required per HDD pack (hddToSSD4 and hhdToSSD9) plus all other SSD/#servers
    let ruleSSD4numberOfSSDPerServer = 0
    // SSD4
    if (chassisArrayLocal[actualChassisID].useSSD4overNVMe4 > 0){
      if ( (HDDmedS/chassisArrayLocal[actualChassisID].hddToSSD4) < (dcConfigArrayLocal[dcItem].numberOfSSD4Needed/actualNumberOfServersForHDD) ){
        ...
        if (Math.ceil(HDDAll/chassisArrayLocal[actualChassisID].hddToSSD4) > Math.ceil(HDDmedS/chassisArrayLocal[actualChassisID].hddToSSD4)){
          ruleSSD4numberOfSSDPerServer = Math.ceil(HDDmedS/chassisArrayLocal[actualChassisID].hddToSSD4) + Math.ceil(HDDmedS/chassisArrayLocal[actualChassisID].hddToSSD9) + Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL + dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL)/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)
          debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 269, `[chassisID=${actualChassisID},dcItem=${dcItem}] ruleSSD4numberOfSSDPerServer=${ruleSSD4numberOfSSDPerServer} = Math.ceil(HDDmedS=${HDDmedS}/chassisArrayLocal[actualChassisID].hddToSSD4=${chassisArrayLocal[actualChassisID].hddToSSD4}) + Math.ceil(HDDmedS=${HDDmedS}/chassisArrayLocal[actualChassisID].hddToSSD9=${chassisArrayLocal[actualChassisID].hddToSSD9}) + Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL} + dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL})/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig})`,0,0,0)    
        }
        else {
          ruleSSD4numberOfSSDPerServer = Math.ceil(HDDAll/chassisArrayLocal[actualChassisID].hddToSSD4) + Math.ceil(HDDmedS/chassisArrayLocal[actualChassisID].hddToSSD9) + Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL + dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL)/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)
          debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 273, `[chassisID=${actualChassisID},dcItem=${dcItem}] ruleSSD4numberOfSSDPerServer=${ruleSSD4numberOfSSDPerServer} = Math.ceil(HDDAll=${HDDmedS}/chassisArrayLocal[actualChassisID].hddToSSD4=${chassisArrayLocal[actualChassisID].hddToSSD4}) + Math.ceil(HDDmedS=${HDDmedS}/chassisArrayLocal[actualChassisID].hddToSSD9=${chassisArrayLocal[actualChassisID].hddToSSD9}) + Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL} + dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL})/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig})`,0,0,0)    
        }
      }
    }
    else {
        ruleSSD4numberOfSSDPerServer = Math.ceil(HDDmedS/chassisArrayLocal[actualChassisID].hddToSSD9) + Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL + dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL)/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 279, `[chassisID=${actualChassisID},dcItem=${dcItem}] ruleSSD4numberOfSSDPerServer=${ruleSSD4numberOfSSDPerServer} = Math.ceil(HDDmedS=${HDDmedS}/chassisArrayLocal[actualChassisID].hddToSSD9=${chassisArrayLocal[actualChassisID].hddToSSD9}) + Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL} + dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL})/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig})`,0,0,0)  
    }

    // SSD9
    // CHECK: the number of SSD must now match the number of SSD required per HDD pack (hddToSSD9 and hddToSSD4) plus all other SSD/#servers
    let ruleSSD9numberOfSSDPerServer = 0
    if (chassisArrayLocal[actualChassisID].useSSD9 > 0){
      if ( (HDDmedS/chassisArrayLocal[actualChassisID].hddToSSD9) < (dcConfigArrayLocal[dcItem].numberOfSSD9Needed/actualNumberOfServersForHDD) ){
        ruleSSD9numberOfSSDPerServer = Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD9Needed/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig) + Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD4Needed/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig) + Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL + dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL)/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 288, `[chassisID=${actualChassisID},dcItem=${dcItem}] ruleSSD9numberOfSSDPerServer=${ruleSSD9numberOfSSDPerServer} = Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD9Needed=${dcConfigArrayLocal[dcItem].numberOfSSD9Needed}/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig}) + Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD9Needed=${dcConfigArrayLocal[dcItem].numberOfSSD9Needed}/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig})=Math.ceil(${dcConfigArrayLocal[dcItem].numberOfSSD9Needed}/${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig}) + Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL} + dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL})/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig})`,0,0,0)  
      }
      else {
        if (Math.ceil(HDDAll/chassisArrayLocal[actualChassisID].hddToSSD9) > Math.ceil(HDDmedS/chassisArrayLocal[actualChassisID].hddToSSD9)){
          ruleSSD9numberOfSSDPerServer = Math.ceil(HDDmedS/chassisArrayLocal[actualChassisID].hddToSSD9) + Math.ceil(HDDmedS/chassisArrayLocal[actualChassisID].hddToSSD4) + Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL + dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL)/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)
          debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 293, `[chassisID=${actualChassisID},dcItem=${dcItem}] ruleSSD9numberOfSSDPerServer=${ruleSSD9numberOfSSDPerServer} = Math.ceil(HDDmedS=${HDDmedS}/chassisArrayLocal[actualChassisID].hddToSSD9=${chassisArrayLocal[actualChassisID].hddToSSD9}) + Math.ceil(HDDmedS=${HDDmedS}/chassisArrayLocal[actualChassisID].hddToSSD9=${chassisArrayLocal[actualChassisID].hddToSSD9}) + Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL} + dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL})/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig})`,0,0,0)    
        }
        else {
          ruleSSD9numberOfSSDPerServer = Math.ceil(HDDAll/chassisArrayLocal[actualChassisID].hddToSSD9) + Math.ceil(HDDmedS/chassisArrayLocal[actualChassisID].hddToSSD4) + Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL + dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL)/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)
          debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 297, `[chassisID=${actualChassisID},dcItem=${dcItem}] ruleSSD9numberOfSSDPerServer=${ruleSSD9numberOfSSDPerServer} = Math.ceil(HDDAll=${HDDmedS}/chassisArrayLocal[actualChassisID].hddToSSD9=${chassisArrayLocal[actualChassisID].hddToSSD9}) + Math.ceil(HDDmedS=${HDDmedS}/chassisArrayLocal[actualChassisID].hddToSSD9=${chassisArrayLocal[actualChassisID].hddToSSD9}) + Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL} + dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL})/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig})`,0,0,0)    
        }
      }
    }
    else {
        ruleSSD9numberOfSSDPerServer = Math.ceil(HDDmedS/chassisArrayLocal[actualChassisID].hddToSSD4) + Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL + dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL)/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)
        debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 303, `[chassisID=${actualChassisID},dcItem=${dcItem}] ruleSSD9numberOfSSDPerServer=${ruleSSD9numberOfSSDPerServer} = Math.ceil(HDDmedS=${HDDmedS}/chassisArrayLocal[actualChassisID].hddToSSD4=${chassisArrayLocal[actualChassisID].hddToSSD9}) + Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBNorWAL} + dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBIncludingWAL})/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig})`,0,0,0)  
    }
    
    let numberOfSSDPerServer = Math.max(ruleSSD4numberOfSSDPerServer,ruleSSD9numberOfSSDPerServer)
    ...
    numberOfNMVePerServer = Math.ceil(Math.ceil(dcConfigArrayLocal[dcItem].numberOfNVMe4Needed/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)/chassisArrayLocal[actualChassisID].hddToNVMe4)
    + Math.ceil(Math.ceil(dcConfigArrayLocal[dcItem].numberOfNVMe9Needed/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)/chassisArrayLocal[actualChassisID].hddToNVMe9)
    ...
    + Math.ceil(Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBDedicatedWAL/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)/chassisArrayLocal[actualChassisID].ssdToNVMe3) 
    + Math.ceil(Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBDedicatedWAL/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)/chassisArrayLocal[actualChassisID].ssdToNVMe3) 
...
debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 327, `[chassisID=${actualChassisID},dcItem=${dcItem}] numberOfNMVePerServer=${numberOfNMVePerServer} = 
    Math.ceil(Math.ceil(dcConfigArrayLocal[dcItem].numberOfNVMe4Needed=${dcConfigArrayLocal[dcItem].numberOfNVMe4Needed}/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig})/chassisArrayLocal[actualChassisID].hddToNVMe4=${chassisArrayLocal[actualChassisID].hddToNVMe4})
    + Math.ceil(Math.ceil(dcConfigArrayLocal[dcItem].numberOfNVMe9Needed=${dcConfigArrayLocal[dcItem].numberOfNVMe9Needed}/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig})/chassisArrayLocal[actualChassisID].hddToNVMe9=${chassisArrayLocal[actualChassisID].hddToNVMe9})
    ...
    + Math.ceil(Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBDedicatedWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithoutDedicatedRocksDBDedicatedWAL}/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig})/chassisArrayLocal[actualChassisID].ssdToNVMe3=${chassisArrayLocal[actualChassisID].ssdToNVMe3}) 
    + Math.ceil(Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBDedicatedWAL=${dcConfigArrayLocal[dcItem].numberOfSSD1NeededWithDedicatedRocksDBDedicatedWAL}/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig})/chassisArrayLocal[actualChassisID].ssdToNVMe3=${chassisArrayLocal[actualChassisID].ssdToNVMe3}) 
...
`,0,0,0)
    ...
    // Check if all the calculated media would fit into the chassis config given and correct if needed:
    if ((numberOfNMVePerServer + numberOfSSDPerServer + Math.ceil(dcConfigArrayLocal[dcItem].numberOfHDDNeeded/actualNumberOfServersForHDD) ) > (chassisArrayLocal[actualChassisID].AllS + chassisArrayLocal[actualChassisID].NdS)) {
      displayMsg(document, "dcConfigDetermineNumberOfServersInitially", 347, "warn", `[chassisID=${actualChassisID},DC=${dcItem}] calculated number of media based on the ratios and needed media is higher than slots available and needs correction: (numberOfNMVePerServer=${numberOfNMVePerServer} + numberOfSSDPerServer=${numberOfSSDPerServer} + Math.ceil(dcConfigArrayLocal[dcItem].numberOfHDDNeeded=${dcConfigArrayLocal[dcItem].numberOfHDDNeeded}/actualNumberOfServersForHDD=${actualNumberOfServersForHDD}) > (chassisArrayLocal[actualChassisID].AllS=${chassisArrayLocal[actualChassisID].AllS} + chassisArrayLocal[actualChassisID].NdS=${chassisArrayLocal[actualChassisID].NdS})`,0,0,0)
      // determine the ratio of needed servers until now to the missing slots 
      dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig = Math.ceil( (numberOfNMVePerServer + numberOfSSDPerServer + Math.ceil(dcConfigArrayLocal[dcItem].numberOfHDDNeeded/actualNumberOfServersForHDD) ) / (chassisArrayLocal[actualChassisID].AllS + chassisArrayLocal[actualChassisID].NdS) * dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)
    }

    // The max of all gives the required server number based on chassis config for media.
    // Check the minimum number of servers required anyways for placing the role instances:
    
    // RFE: might be improved to really use the actual configuration of the workloads to pick the best h/w config and not pick more than needed for minimum - this actually assumes that there are always 2nd scale-out instances. However, on the other hand, it might be a good practice to
    //      to always leave room for taking the roles if a server fails and a place to go for the missing instances of the roles would be needed on another server.
    ...
    if (generalValues.desiredSameMediaConfig === true ) {
      ...
      debugMsg(generalValues, localDebugOn, 5, "dcConfigDetermineNumberOfServersInitially", 367, `[chassisID=${actualChassisID},dcItem=${dcItem}] INFO - same media config is currently not supported`,0,0,0)
    }
  } 
}
