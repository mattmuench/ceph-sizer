...
const dcConfigDetermineNumberOfServersInitially = function (generalValuesLocal, dcConfigArrayLocal, chassisArrayLocal, actualChassisID, dcItem) {
  ...
  // CALC: SSDAll
  let localNumberOfAllSSD = dcConfigArrayLocal[dcItem].numberOfSSD4Needed + dcConfigArrayLocal[dcItem].numberOfSSDWithoutDedicatedNVMeNeeded + dcConfigArrayLocal[dcItem].numberOfSSDWithDedicatedNVMeNeeded
  console.log(`dcConfigDetermineNumberOfServersInitially() 12: [chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllSSD=${localNumberOfAllSSD}`)
  // CALC: NAll
  let localNumberOfAllNVMe =  dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithoutDedicatedWAL
                            + dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithDedicatedWAL
  ...
  console.log(`dcConfigDetermineNumberOfServersInitially() 22: [chassisID=${actualChassisID},dcItem=${dcItem}] localNumberOfAllNVMe=${localNumberOfAllNVMe}`)
  ...
  if (generalValuesLocal.desiredSimilarMediaConfig == 1) {
    ...
    console.log(`dcConfigDetermineNumberOfServersInitially() 185: [chassisID=${actualChassisID},dcItem=${dcItem}] HDDmedS=${HDDmedS}, SSDmedS=${SSDmedS}`)
            
    /// Check: All above must serve AllmedS (1) = maxAllMediaSum >= HDDmedS + SSDmedS + NmedS + NdS and AllS = maxAllSlots >= HDDmedS + SSDmedS + NmedS
    if ( chassisArrayLocal[actualChassisID].maxAllMediaSum < (HDDmedS + SSDmedS + NmedS + NdS)) {
    ...
    if ( chassisArrayLocal[actualChassisID].maxAllSlots < (HDDmedS + SSDmedS + NmedS)) {
    ...
    if ((NmedS + NdS)> 0) {
      actualNumberOfServersForNVMe = Math.ceil(localNumberOfAllNVMe / (NmedS + NdS))
      console.log(`dcConfigDetermineNumberOfServersInitially() 200: [chassisID=${actualChassisID},dcItem=${dcItem}] actualNumberOfServersForNVMe=${actualNumberOfServersForNVMe}`)
    }
    ...
    if (chassisArrayLocal[actualChassisID].useSSD4overNVMe4 > 0){
      if ( (HDDmedS/chassisArrayLocal[actualChassisID].hddToSSD4) < (dcConfigArrayLocal[dcItem].numberOfSSD4Needed/actualNumberOfServersForHDD) ){
        ...
        if (Math.ceil(HDDAll/chassisArrayLocal[actualChassisID].hddToSSD4) > Math.ceil(HDDmedS/chassisArrayLocal[actualChassisID].hddToSSD4)){
          numberOfSSDPerServer = Math.ceil(HDDmedS/chassisArrayLocal[actualChassisID].hddToSSD4) + Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSDWithoutDedicatedNVMeNeeded + dcConfigArrayLocal[dcItem].numberOfSSDWithDedicatedNVMeNeeded)/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)
          ...
          numberOfSSDPerServer = Math.ceil(HDDAll/chassisArrayLocal[actualChassisID].hddToSSD4) + Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSDWithoutDedicatedNVMeNeeded + dcConfigArrayLocal[dcItem].numberOfSSDWithDedicatedNVMeNeeded)/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)
        ...
        numberOfSSDPerServer = Math.ceil((dcConfigArrayLocal[dcItem].numberOfSSDWithoutDedicatedNVMeNeeded + dcConfigArrayLocal[dcItem].numberOfSSDWithDedicatedNVMeNeeded)/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)
    ...
    if (chassisArrayLocal[actualChassisID].useSSD4overNVMe4 < 1){
      if ( (HDDmedS/chassisArrayLocal[actualChassisID].hddToNVMe4) < (dcConfigArrayLocal[dcItem].numberOfNVMe4Needed/actualNumberOfServersForHDD) ){
        ...
        if (chassisArrayLocal[actualChassisID].useOptane1) {
          numberOfNMVePerServer += Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSDWithDedicatedNVMeNeeded/chassisArrayLocal[actualChassisID].ssdToOptane) 
      ...
      numberOfNMVePerServer = Math.ceil(Math.ceil(dcConfigArrayLocal[dcItem].numberOfSSDWithDedicatedNVMeNeeded/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)/chassisArrayLocal[actualChassisID].ssdToNVMe5) 
                            + Math.ceil(Math.ceil(dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithDedicatedWAL/dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)/chassisArrayLocal[actualChassisID].nvmeToNVMe7) 
                            + Math.ceil(dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithoutDedicatedWAL / dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)
                            + Math.ceil(dcConfigArrayLocal[dcItem].numberOfNVMe1NeededWithDedicatedWAL / dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig)
    ...
    // The max of all gives the required server number based on chassis config for media.
    dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig = Math.max(actualNumberOfServersForNVMe, actualNumberOfServersForHDD, actualNumberOfServersForSSD)
    console.log(`dcConfigDetermineNumberOfServersInitially() 289: [chassisID=${actualChassisID},dcItem=${dcItem}] dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig=${dcConfigArrayLocal[dcItem].numberOfServersNeededBasedOnChassisConfig}`)
  }
  else {
