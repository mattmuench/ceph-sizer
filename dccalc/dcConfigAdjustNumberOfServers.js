...
const dcConfigAdjustNumberOfServers   = function (sizingConstraints, dcConfigArrayLocal, chassisArrayLocal, actualChassisID, dcItem) {
  ...
  if (dcConfigArrayLocal[dcItem].constraintsBasedOnNothing === true) {
    ...
    //-disabled by RGW cache separation disabled/// if (dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe2Needed > 0) {
      ...
      // We want to use the maximum of either servers needed (at minimum) based on cores or on memory.
        if ( dcConfigArrayLocal[dcItem].prelimPerServerNumberOfCoresNeeded > (chassisArrayLocal[actualChassisID].maxCpuSockets * chassisArrayLocal[actualChassisID].maxCpuCores) ) {
          ...
          if (localMinServersForRoles <= dcConfigArrayLocal[dcItem].prelimNumberOfServers) {
            ...
            console.log(`dcConfigAdjustNumberOfServers 69: ERROR - unable to place all roles to preliminary number of servers already - number of servers must be increased`)
          ...
          if (chassisArrayLocal[actualChassisID].useRGWCaching === false) {
            // RGW cache used:
            console.log(`dcConfigAdjustNumberOfServers() 94: [chassisID=${actualChassisID},DC=${dcItem}] ERROR: Workload requires RGW cache device but config doesn't provide it`)
          }
          else {
            // Set this is not done before - actually, this is a single device per server setting (no selection of how many would be used)
            dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe2Needed = 1
          }
          ...
          dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1Needed = (dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1NeededWithDedicatedWAL + dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1NeededWithoutDedicatedWAL)
          console.log(`dcConfigAdjustNumberOfServers() 202: dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1Needed=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1Needed}, dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1NeededWithDedicatedWAL=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1NeededWithDedicatedWAL}, dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1NeededWithoutDedicatedWAL=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1NeededWithoutDedicatedWAL}`)
              ...
              if (scoreCoresPerMediaType[mediatype].score > highScore){
                ...
                let localReduceToMinRoles = // number of media to size the config per server down for the actual media
                                                  Math.ceil(( chassisArrayLocal[actualChassisID].maxCpuSockets * chassisArrayLocal[actualChassisID].maxCpuCores 
                                                          ...
                                                          - dcConfigArrayLocal[dcItem].prelimPerServerNumberOfSSDNeeded * sizingConstraints.coresPerSSDold
                                                          - dcConfigArrayLocal[dcItem].prelimPerServerNumberOfHDDNeeded * sizingConstraints.coresPerHDD
                                                          - dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1Needed * sizingConstraints.coresPerNVMe1
                ...
                console.log(`dcConfigAdjustNumberOfServers() 251a: dcConfigArrayLocal[dcItem].prelimPerServerNumberOfSSDNeeded=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfSSDNeeded} * sizingConstraints.coresPerSSDold=${sizingConstraints.coresPerSSDold}`)
                ...
                console.log(`dcConfigAdjustNumberOfServers() 251c: dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1Needed=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1Needed} * sizingConstraints.coresPerNVMe1=${sizingConstraints.coresPerNVMe1}`)
                ...
                console.log(`dcConfigAdjustNumberOfServers() 296a: dcConfigArrayLocal[dcItem].prelimPerServerNumberOfSSDNeeded=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfSSDNeeded} * sizingConstraints.coresPerSSDold=${sizingConstraints.coresPerSSDold}`)
                ...
                console.log(`dcConfigAdjustNumberOfServers() 296c: dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1Needed=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1Needed} * sizingConstraints.coresPerNVMe1=${sizingConstraints.coresPerNVMe1}`)
          ...
          if (localMinScaleOutRolesPerServer == 2) {
            ...
            (  dcConfigArrayLocal[dcItem].prelimPerServerNumberOfHDDNeeded=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfHDDNeeded} * sizingConstraints.coresPerHDD=${sizingConstraints.coresPerHDD}
            +dcConfigArrayLocal[dcItem].prelimPerServerNumberOfSSDNeeded=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfSSDNeeded} * sizingConstraints.coresPerSSDold=${sizingConstraints.coresPerSSDold}
            +dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1Needed=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1Needed} * sizingConstraints.coresPerNVMe1=${sizingConstraints.coresPerNVMe1}
            +dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe3Needed=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe3Needed} * sizingConstraints.coresPerNVMe3=${sizingConstraints.coresPerNVMe3}
            +dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe4Needed=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe4Needed} * sizingConstraints.coresPerNVMe4=${sizingConstraints.coresPerNVMe4}
            +dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe5Needed=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe5Needed} * sizingConstraints.coresPerNVMe5=${sizingConstraints.coresPerNVMe5}
            +dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe6Needed=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe6Needed} * sizingConstraints.coresPerNVMe6=${sizingConstraints.coresPerNVMe6}
        ...
        if (dcConfigArrayLocal[dcItem].prelimPerServerMemNeededPerServer > chassisArrayLocal[actualChassisID].maxMemGb) {
          ...
          if (localMinServersForRoles <= dcConfigArrayLocal[dcItem].prelimNumberOfServers) {
            ...
            console.log(`dcConfigAdjustNumberOfServers 427: ERROR - unable to place all roles to preliminary number of servers already - number of servers must be increased`)
            /// MUST ADJUST PRELIM #servers
            dcConfigArrayLocal[dcItem].prelimNumberOfServers = localMinServersForRoles
          }
          ...
          let lowestMinServersMediaTypeMaxRoles = 0
          dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1Needed = (dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1NeededWithDedicatedWAL + dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1NeededWithoutDedicatedWAL)
          console.log(`dcConfigAdjustNumberOfServers() 458: dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1Needed=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1Needed}, dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1NeededWithDedicatedWAL=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1NeededWithDedicatedWAL}, dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1NeededWithoutDedicatedWAL=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1NeededWithoutDedicatedWAL}`)
          for (let mediatype = 0; mediatype < scoreMemPerMediaType.length; mediatype++) {
            ...
            if (scoreMemPerMediaType[mediatype].number > 1) {
              ...
              if (scoreMemPerMediaType[mediatype].score > highScore){
                ...
                console.log(`dcConfigAdjustNumberOfServers() 505a: dcConfigArrayLocal[dcItem].prelimPerServerNumberOfSSDNeeded=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfSSDNeeded} * sizingConstraints.memInGBPerSSD=${sizingConstraints.memInGBPerSSD}`)
                ...
                console.log(`dcConfigAdjustNumberOfServers() 505c: dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1Needed=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1Needed} * sizingConstraints.memInGBPerNVMe1=${sizingConstraints.memInGBPerNVMe1}`)
                ...
                console.log(`dcConfigAdjustNumberOfServers() 549a: dcConfigArrayLocal[dcItem].prelimPerServerNumberOfSSDNeeded=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfSSDNeeded} * sizingConstraints.memInGBmPerSSD=${sizingConstraints.memInGBPerSSD}`)
                ...
                console.log(`dcConfigAdjustNumberOfServers() 549c: dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1Needed=${dcConfigArrayLocal[dcItem].prelimPerServerNumberOfNVMe1Needed} * sizingConstraints.memInGBPerNVMe1=${sizingConstraints.memInGBPerNVMe1}`)
