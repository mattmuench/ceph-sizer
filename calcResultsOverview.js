...
const calcResultsOverview = function (generalValues, configsArrayLocal, chassisArrayLocal, resultsOverviewArrayLocal) {
    ...
    for (let actualChassisID = 0; actualChassisID < generalValues.numberOfConfigsPossible; actualChassisID++) {
        ...
        for (let dcItem = 0; dcItem < generalValues.numberOfDCsPossible; dcItem++) {
            ...
            console.log(`calcResultsOverview() 19: dcItem=${dcItem}, actualChassisID=${actualChassisID},configsArrayLocal[actualChassisID][dcItem].numberOfWorkloadsInDC=${configsArrayLocal[actualChassisID][dcItem].numberOfWorkloadsInDC}`)
            if (configsArrayLocal[actualChassisID][dcItem].numberOfWorkloadsInDC > 0){
                // do the calculation for the overview
                console.log(`calcResultsOverview() 22: dcItem=${dcItem}, actualChassisID=${actualChassisID}, value from configs for resultingNumberOfServersAsPerChassis=${configsArrayLocal[actualChassisID][dcItem].resultingNumberOfServersAsPerChassis}`)
                ...
                */
                ...
                console.log(`calcResultsOverview() 84: dcItem=${dcItem}, actualChassisID=${actualChassisID}, => no workloads in DC = ignoring DC`)
            }
        }
