...
class TableHeaderWorkloads {
    constructor () {
        this.header = [
            ...
            ["Use dedicated flash pool for rgw index using RocksDB flash media?","selector-rgw-index-flash","checkbox"],
            ["Use dedicated flash pool for rgw index using dedicated flash media?","selector-rgw-index-dedicatedflash","checkbox"],
