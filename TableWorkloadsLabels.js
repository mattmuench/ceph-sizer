...
class TableHeaderWorkloads {
    constructor () {
        this.header = [
            ...
            ["HDD: Use dedicated flash media for RocksDB (OSD metadata) on NVMe4 ?","selector-HDDdedicatedNVMe","checkbox"],
            ["HDD: Use dedicated flash media for separating WAL (w/ or w/o separate RocksDB) on NVMe9 ?","selector-HDDdedicatedNVMeForWAL","checkbox"],
            ["HDD: Use dedicated flash media for RocksDB (OSD metadata) on SSD4 ?","selector-HDDdedicatedSSD","checkbox"],
            ["HDD: Use dedicated flash media for separating WAL (w/ or w/o separate RocksDB) on SSD9 ?","selector-HDDdedicatedSSDForWAL","checkbox"],
